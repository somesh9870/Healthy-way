    ...
    <>
        ...
        >
          ...
          <Flex flexDir={"column"}>
            ...
            <Flex>
              ...
              >
                <BiHelpCircle size="1em" />
                {navSize == "small" ? "" : "Support"}
              </Button>
            </Flex>
          </Flex>
        </Flex>
      ...
      >
        <Flex alignItems="center" gap="10px">
          <Avatar name={localStorage.getItem("userEmail")} size="sm" />
          <Text
        ...
        <Button
          ...
          backgroundColor="#44d07b"
          color="#272a3a"
          _hover={{ bgColor: "#3b3f4d", color: "#44d07b" }}
          gap="10px"
          fontSize="15px"
          size={{ base: "xs", md: "sm", lg: "md" }}
        >
